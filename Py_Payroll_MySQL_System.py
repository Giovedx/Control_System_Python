      ...
      def addData():
          if EmployeeName.get() =="" or Address.get()=="" or Reference.get()=="":
            ...
            sqlCon = pymysql.connect(host     = "localhost" , 
                                     ...
                                     database = "payment")
            cur    = sqlCon.cursor()
            cur.execute("insert into payment values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",( 
            ...
            DisplayData()
            sqlCon.close()
            tkinter.messagebox.showinfo("Data Entry Form",
                                        "Record Entered Successfully")

#------------------------------------------------------------------------------

      def DisplayData():
          sqlCon = sqlCon = pymysql.connect(host     = "localhost" , 
                                            user     = "root"           ,
                                            password = "elgio"          ,
                                            database = "payment")
          cur    = sqlCon.cursor()
          ...
          if len(result) != 0:
             ...
             for row in result:
                     self.payroll_records.insert('',END,values = row)
             sqlCon.commit()
          sqlCon.close()
 ...
 #-----------------------------------------------------------------------------         
      ...
      def update():
            sqlCon = sqlCon = pymysql.connect(host     = "localhost" , 
                                             ...
                                             database = "payment")
            cur    = sqlCon.cursor()   
            cur.execute(" update payment set firstname=%s     , \
                                             address=%s       , \
                                             cityweighting=%s , \
                                             basicsalary=%s   , \
                                             overtime=%s      , \
            ...
            DisplayData()
            sqlCon.close()
            tkinter.messagebox.showinfo("Data Entry Form", "Record Successfully Update")
...
#-----------------------------------------------------------------------------
      ...
      def deleteDB():
            sqlCon = sqlCon = pymysql.connect(host     = "localhost" , 
                                              ...
                                              database = "payment")
            cur    = sqlCon.cursor()   
            cur.execute("delete from payment where ref=%s")
...
#------------------------------Frame tab control------------------------------------
      ...
      Tab2Frame = Frame(self.TabControl2,
                        bd     = 10   ,
                        width  = 1350 ,
                        height = 700  ,
                        relief = RIDGE )
      ...
      Tab3Frame = Frame(self.TabControl3,
                        bd     = 10   ,
                        width  = 1350 ,
                        height = 700  ,
                        relief = RIDGE )
      ...
      LeftFrame2Left = Frame(LeftFrame2,
                             bd     = 5    ,
                             width  = 300  ,
                             height = 170  ,
                             padx   = 2    ,
      ...
      LeftFrame2Right = Frame(LeftFrame2,
                              bd     = 5   ,
                              width  = 300 ,
                              height = 170 ,
                              padx   = 2   ,
      ...
      LeftFrame3Left = Frame(LeftFrame,
                             bd      = 5   ,
                             width   = 320 ,
                             height  = 50  ,
                             padx    = 2   ,
      ...
      LeftFrame3Right = Frame(LeftFrame,
                              bd     = 5   ,
                              width  = 320 ,
                              height = 50  ,
                              padx   = 2   ,
      ...
      RightFrame1a = Frame (RightFrame1,
                           bd     = 5   ,
                           width  = 310 ,
                           height = 300 ,
                           padx   = 2   ,
      ...
      RightFrame1b = Frame (RightFrame1,
                          bd     = 5   ,
                          width  = 310 ,
                          height = 100 ,
                          padx   = 2   ,
      ...
      RightFrame2a = Frame (RightFrame2,
                            bd     = 5    ,
                            width  = 280  ,
                            height = 50   ,
                            padx   = 2    ,
      ...
      RightFrame2b = Frame (RightFrame2,
                            bd     = 5    ,
                            width  = 280  ,
                            height = 180  ,
                            padx   = 2    ,
      ...
      RightFrame2c = Frame (RightFrame2,
                            bd     = 5    ,
                            width  = 280  ,
                            height = 100  ,
                            padx   = 2    ,
      ...
      RightFrame2d = Frame (RightFrame2,
                            bd     = 5    ,
                            width  = 280  ,
                            height = 50   ,
                            padx   = 2    ,
...
# -----------------------------------------------------------------------------
      ...
      self.lblEmployeeName = Label (TopFrame2,
                                    font    = ('arial',12,'bold') ,
                                    text    = "Employee Name"     ,
                                    bd      = 10 )
      self.lblEmployeeName.grid(row    = 0,
                                column = 0,
                                sticky = W)
     
      self.txtEmployeeName = Entry (TopFrame2,
                                    font         = ('arial',12,'bold') ,
                                    bd           = 5                   ,
                                    width        = 59                  ,
                                    justify      = 'left'              ,
                                    textvariable =  EmployeeName)
      self.txtEmployeeName.grid(row    = 0,
                                column = 1)
      
     #------------------
      
      self.lblAddress = Label (TopFrame2,
                                    font    = ('arial',12,'bold') ,
                                    text    = "Address"           ,
                                    bd      = 10 )
      self.lblAddress.grid(row    = 1 ,
                           column = 0 ,
                           sticky = W )
      ...
      self.txtAddress.grid(row    = 1,
                           column = 1)
      #--------------
      
      self.lblPostCode = Label (TopFrame2,
                                    font    = ('arial',12,'bold') ,
                                    text    = "Post Code"     ,
                                    bd      = 5 )
      self.lblPostCode.grid(row    = 0,
                            column = 2,
                            sticky = W)
      self.txtPostCode = Entry (TopFrame2,
                                    font         = ('arial',12,'bold') ,
                                    bd           = 5                   ,
                                    width        = 57                  ,
                                    justify      = 'left'              ,
                                    textvariable =  PostCode)
      self.txtPostCode.grid(row    = 0,
                            column = 3)
      
      #---------------
      
      self.lblGender = Label (TopFrame2,
                                    font    = ('arial',12,'bold') ,
                                    text    = "Gender"            ,
                                    bd      = 10 )
      self.lblGender.grid(row    = 1,
                          column = 2,
                          sticky = W)
      self.cboGender =ttk.Combobox(TopFrame2,
                                   textvariable  = Gender              ,
                                   state         = 'readonly'          ,
                                   font          = ('arial',14,'bold') ,
                                   width         = 46)
      ...
      self.cboGender.grid(row    = 1,
                          column = 3)
      
#--------------------------------------------------------------------------------
      
      self.lblPayday = Label(RightFrame2a,
                             font  = ('arial',12,'bold'),
                             text  = "Payday"           ,
                             bd    =  10)
      self.lblPayday.grid(row    = 0,
                          column = 0,
                          sticky = W)
      ...
      self.txtPayday.grid(row    = 0,
                          column = 1)
      
      #----------
      
      
      self.lblTaxPeriod = Label(RightFrame2b,
                             font  = ('arial',12,'bold'),
                             text  = "Tax Period"           ,
                             bd    =  10)
      self.lblTaxPeriod.grid(row    = 0,
                             column = 0,
                             sticky = W)
      ...
      self.txtTaxPeriod.grid(row    = 0,
                             column = 1)
      
      #----------
      
      self.lblTaxCode = Label(RightFrame2b,
                             font  = ('arial',12,'bold'),
                             text  = "Tax Code"           ,
                             bd    =  10)
      self.lblTaxCode.grid(row    = 1,
                           column = 0,
                           sticky = W)
      ...
      self.txtTaxCode.grid(row    = 1,
                           column = 1)
      
      #----------
            
      self.lblNINumber = Label(RightFrame2b,
                              font  = ('arial',12,'bold'),
                              text  = "NI Number"           ,
                              bd    =  10)
      self.lblNINumber.grid(row    = 2,
                            column = 0,
                            sticky = W)
      self.txtNINumber  = Entry(RightFrame2b,
                                font          = ('arial',12,'bold'),
                                bd            = 5                  ,
                                width         = 16                 ,
                                justify       = 'left'             ,
      ...
      self.txtNINumber.grid(row    = 2,
                            column = 1)
      
      #-----------
      
      self.lblNICode = Label(RightFrame2b,
                              font  = ('arial',12,'bold'),
                              text  = "NI Code "           ,
                              bd    =  10)
      self.lblNICode.grid(row    = 3,
                          column = 0,
                          sticky = W)
      self.txtNICode   = Entry(RightFrame2b,
                             font          = ('arial',12,'bold'),
                             bd            = 5                  ,
                             width         = 16                 ,
                             justify       = 'left'             ,
      ...
      self.txtNICode.grid(row    = 3,
                          column = 1)
      
      #----------
      
      self.lblTaxablePay = Label(RightFrame2c,
                                 font  = ('arial',12,'bold'),
                                 text  = "Taxable Pay"           ,
                                 bd    =  10)
      self.lblTaxablePay.grid(row    = 0,
                              column = 0,
                              sticky = W)
      self.txtTaxablePay = Entry(RightFrame2c,
                                 font          = ('arial',12,'bold'),
                                 bd            = 5                  ,
                                 width         = 11                 ,
                                 justify       = 'left'             ,
      ...
      self.txtTaxablePay.grid(row    = 0,
                              column = 1)
      
      #-----------
      
      self.lblPensionablePay = Label(RightFrame2c,
                                     font  = ('arial',12,'bold'),
                                     text  = "Pensionable Pay"   ,
                                     bd    =  10)
      self.lblPensionablePay.grid(row    = 1,
                                  column = 0,
                                  sticky = W)
      self.txtPensionablePay  = Entry(RightFrame2c,
                                      font          = ('arial',12,'bold'),
                                      bd            = 5                  ,
                                      width         = 11                 ,
                                      justify       = 'left'             ,
      ...
      self.txtPensionablePay.grid(row    = 1,
                                  column = 1)
      
      #----------
      
      self.lblNetPay = Label(RightFrame2d,
                                     font  = ('arial',12,'bold'),
                                     text  = "Net Pay"           ,
                                     bd    =  10)
      self.lblNetPay.grid(row    = 0,
                          column = 0,
                          sticky = W)
      ...
      self.txtNetPay.grid(row    = 0,
                          column = 1)
           
      
#--------------------------------------------------------------------------------
 
      self.lblReference = Label(LeftFrame1,
                                font  = ('arial',12,'bold'),
                                text  = "Reference"           ,
                                bd    =  10)
      self.lblReference.grid(row    = 0,
                             column = 0,
                             sticky = W)
      self.txtReference = Entry(LeftFrame1,
                                font          = ('arial',12,'bold'),
                                bd            = 5                  ,
                                width         = 57                 ,
                                justify       = 'left'             ,
      ...
      self.txtReference.grid(row    = 0,
                             column = 1)
      
      #----------
      
      self.lblEmployerName = Label(LeftFrame1,
                                   font  = ('arial',12,'bold'),
                                   text  = "Employer Name"           ,
                                   bd    =  10)
      self.lblEmployerName.grid(row    = 1,
                                column = 0,
                                sticky = W)
      self.txtEmployerName = Entry(LeftFrame1,
                                   font          = ('arial',12,'bold'),
                                   bd            = 5                  ,
                                   width         = 57                 ,
                                   justify       = 'left'             ,
      ...
      self.txtEmployerName.grid(row    = 1,
                                column = 1)
      
       #--------
      
      self.lblEmployeeName = Label(LeftFrame1,
                                   font  = ('arial',12,'bold'),
                                   text  = "Employee Name"           ,
                                   bd    =  10)
      self.lblEmployeeName.grid(row    = 2,
                                column = 0,
                                sticky = W)
      self.txtEmployeeName = Entry(LeftFrame1,
                                   font          = ('arial',12,'bold'),
                                   bd            = 5                  ,
                                   width         = 57                 ,
                                   justify       = 'left'             ,
      ...
      self.txtEmployeeName.grid(row    = 2,
                                column = 1)
      
#--------------------------------------------------------------------------------

  
      self.lblCityWeighting = Label(LeftFrame2Left,
                                   font  = ('arial',12,'bold'),
                                   text  = "City Weighting"           ,
                                   bd    =  10,
                                   anchor= 'e')
      self.lblCityWeighting.grid(row    = 0,
                                 column = 0,
                                 sticky = W)
      self.txtCityWeighting = Entry(LeftFrame2Left,
                                   font          = ('arial',12,'bold'),
                                   bd            = 5                  ,
                                   width         = 20                 ,
                                   justify       = 'left'             ,
      ...
      self.txtCityWeighting.grid(row    = 0,
                                 column = 1)
      
      #---------
      
      
      self.lblBasicSalary = Label(LeftFrame2Left,
                                   font  = ('arial',12,'bold'),
                                   text  = "Basic Salary"        ,
                                   bd    =  10)
      self.lblBasicSalary.grid(row    = 1,
                               column = 0,
                               sticky = W)
      self.txtBasicSalary = Entry(LeftFrame2Left,
                                   font          = ('arial',12,'bold'),
                                   bd            = 5                  ,
                                   width         = 20                 ,
                                   justify       = 'left'             ,
      ...
      self.txtBasicSalary.grid(row    = 1,
                               column = 1)
      
      #---------
      
      self.lblOverTime = Label(LeftFrame2Left,
                                   font  = ('arial',12,'bold'),
                                   text  = "Over Time"        ,
                                   bd    =  10)
      self.lblOverTime.grid(row    = 2,
                            column = 0,
                            sticky = W)
      self.txtOverTime = Entry(LeftFrame2Left,
                                   font          = ('arial',12,'bold'),
                                   bd            = 5                  ,
                                   width         = 20                 ,
                                   justify       = 'left'             ,
      ...
      self.txtOverTime.grid(row    = 2,
                            column = 1)
      
      #---------
      
      self.lblOtherPaymentDue = Label(LeftFrame2Left,
                                   font  = ('arial',12,'bold'),
                                   text  = "Other Payment"        ,
                                   bd    =  10)
      self.lblOtherPaymentDue.grid(row    = 3,
                                   column = 0,
                                   sticky = W)
      self.txtOtherPaymentDue = Entry(LeftFrame2Left,
                                   font          = ('arial',12,'bold'),
                                   bd            = 5                  ,
                                   width         = 20                 ,
                                   justify       = 'left'             ,
      ...
      self.txtOtherPaymentDue.grid(row    = 3,
                                   column = 1)
     

#--------------------------------------------------------------------------------

      self.lblTax = Label(LeftFrame2Right,
                          font   = ('arial',12,'bold'),
                          text   = "Tax"        ,
                          bd     =  10,
                          anchor =  'e')
      self.lblTax.grid(row    = 0,
                       column = 0,
                       sticky = W)
      ...
      self.txtTax.grid(row    = 0,
                       column = 1)
              
     #----------     
     
      self.lblPension = Label(LeftFrame2Right,
                              font   = ('arial',12,'bold'),
                              text   = "Pension"        ,
                              bd     =  10)
      self.lblPension.grid(row    = 1,
                           column = 0,
                           sticky = W)
      ...
      self.txtPension.grid(row    = 1,
                           column = 1)
          
     
     #---------- 
     
      self.lblStudentLoan = Label(LeftFrame2Right,
                                  font   = ('arial',12,'bold'),
                                  text   = "Student Loan"     ,
                                  bd     =  10)
      self.lblStudentLoan.grid(row    = 2,
                               column = 0,
                               sticky = W)
      self.txtStudentLoan= Entry(LeftFrame2Right,
                                 font          = ('arial',12,'bold'),
                                 bd            = 5                  ,
                                 width         = 20                 ,
                                 justify       = 'left'             ,
      ...
      self.txtStudentLoan.grid(row    = 2,
                               column = 1)
          
     
     #---------- 
      
      self.lblNIPayment = Label(LeftFrame2Right,
                                  font   = ('arial',12,'bold'),
                                  text   = "NI Payment"        ,
                                  bd     =  10)
      self.lblNIPayment.grid(row    = 3,
                             column = 0,
                             sticky = W)
      self.txtNIPayment= Entry(LeftFrame2Right,
                               font          = ('arial',12,'bold'),
                               bd            = 5                  ,
                               width         = 20                 ,
                               justify       = 'left'             ,
      ...
      self.txtNIPayment.grid(row    = 3,
                             column = 1)
          
     
#--------------------------------------------------------------------------------
      
      self.lblGrossPay = Label(LeftFrame3Left,
                               font   = ('arial',12,'bold'),
                               text   = "Gross Pay"        ,
                               bd     =  10)
      self.lblGrossPay.grid(row    = 3,
                            column = 0,
                            sticky = W)
      self.txtGrossPay= Entry(LeftFrame3Left,
                              font          = ('arial',12,'bold'),
                              bd            = 5                  ,
                              width         = 23                 ,
                              justify       = 'left'             ,
      ...
      self.txtGrossPay.grid(row    = 3,
                            column = 1)
      
      #--------
      
      self.lblDeductions = Label(LeftFrame3Right,
                                  font   = ('arial',12,'bold'),
                                  text   = "Deductions"        ,
                                  bd     =  10)
      self.lblDeductions.grid(row    = 3,
                              column = 0,
                              sticky = W)
      self.txtDeductions= Entry(LeftFrame3Right,
                               font          = ('arial',12,'bold'),
                               bd            = 5                  ,
                               width         = 23                 ,
                               justify       = 'left'             ,
...
#------------------------------------Calculator--------------------------------------------    
      ...
      self.txtDisplay.grid(row        = 0 ,
                           column     = 0 ,
                           columnspan = 4 )
      #-----------
      
      self.btnDigit7 = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 6                   ,
                              bd    = 2                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnDigit8 = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 6                   ,
                              bd    = 2                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnDigit9 = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 6                   ,
                              bd    = 2                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnAdd = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 6                   ,
                              bd    = 2                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnDigit4 = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 7                   ,
                              bd    = 2                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnDigit5 = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 7                   ,
                              bd    = 2                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnDigit6 = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 7                   ,
                              bd    = 2                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnSub = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 7                   ,
                              bd    = 2                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnDigit1 = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 7                   ,
                              bd    = 2                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnDigit2 = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 7                   ,
                              bd    = 2                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnDigit3 = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 7                   ,
                              bd    = 2                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnMulti = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 7                   ,
                              bd    = 2                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnDigit0 = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 7                   ,
                              bd    = 2                   ,
                              fg    = "black"             ,
      ...
      self.btnClear = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 7                   ,
                              bd    = 2                   ,
                              fg    = "black"             ,
      ...
      self.btnEquals = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 7                   ,
                              bd    = 2                   ,
                              fg    = "black"             ,
      ...
      self.btnDiv = Button(RightFrame1a,
                              padx  = 6                   ,
                              pady  = 7                   ,
                              bd    = 2                   ,
                              fg    = "black"             ,
      ...
      self.btnWages = Button(RightFrame1b,
                              padx  = 16                   ,
                              pady  = 0                   ,
                              bd    = 5                   ,
                              font  = ('arial',16,'bold') ,
                              width = 4                   ,
                              text  = 'Wages',
                              command=Payment_Function).grid(row=0,column=0)

      self.btnDisplay = Button(RightFrame1b,
                              padx  = 16                   ,
                              pady  = 0                   ,
                              bd    = 5                   ,
                              font  = ('arial',16,'bold') ,
                              width = 4                   ,
                              text  = 'Display',
                              command=addData).grid(row=0,column=1)
      
      self.btnUpdate = Button(RightFrame1b,
                              padx  = 16                   ,
                              pady  = 0                   ,
                              bd    = 5                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnDelete = Button(RightFrame1b,
                              padx  = 16                  ,
                              pady  = 0                   ,
                              bd    = 5                   ,
                              font  = ('arial',16,'bold') ,
      ...
      self.btnReset = Button(RightFrame1b,
                             padx  = 16                  ,
                             pady  = 0                   ,
                             bd    = 5                   ,
                             font  = ('arial',16,'bold') ,
      ...
      self.btnExit = Button(RightFrame1b,
                             padx  = 16                  ,
                             pady  = 0                   ,
                             bd    = 5                   ,
                             font  = ('arial',16,'bold') ,
                             width = 4                   ,
                             text  = 'Exit',
                             command=iExit).grid(row=1,column=2)


#--------------------------------------------------------------------------------
  
      TopFrame11 = Frame (Tab2Frame,
                          bd     = 5    ,
                          width  = 1340 ,
                          height = 100  ,
                          relief = RIDGE)
      TopFrame11.grid(row    = 0,
                      column = 0)
      
      TopFrame12 = Frame (Tab2Frame,
                          bd      = 10   ,
                          width   = 1340 ,
                          height  = 100  ,
                          relief  = RIDGE)
...
#--------------------------------------------------------------------------------
      ...
      self.lblTitle = Label(TopFrame11,
                            font    = ('arial',40,'bold')               ,
                            text    = "\t Payroll Management System \t" ,
                            bd      = 10                                ,
                            justify = CENTER)
...
#--------------------------------------------------------------------------------
      ...
      scroll_x = Scrollbar(TopFrame12,
                           orient = HORIZONTAL)
      scroll_y = Scrollbar(TopFrame12,
                           orient = VERTICAL)
      
      self.payroll_records = ttk.Treeview(TopFrame12,
                                          height=22                ,
                                          columns=("ref"           ,
                                                  "fullname"       ,
                                                  "address"        ,
    ...
    #--------------  
      ...
      self.payroll_records.column("address" ,width=70)
...
#--------------------------------------------------------------------------------
      TopFrame13 = Frame(Tab3Frame,
                         bd     = 10   ,
                         width  = 1340 ,
                         height = 100  ,
                         relief = RIDGE)
      TopFrame13.grid(row    = 0,
                      column = 0)
#--------------------------------------------------------------------------------
      
      self.lblNote = Label(TopFrame13,
                            font    = ('arial',40,'bold')       ,
                            text    = "\t Payroll Note Book \t" ,
                            bd      = 10                        ,
                            justify = CENTER)
      self.lblNote.grid(row    = 0,
                        column = 0)

#--------------------------------------------------------------------------------
      self.txtNote = Text(TopFrame13,
                          width  = 120  ,
                          height = 22  ,
                          font   = ('arial',14,'bold'))
      self.txtNote.grid(row   = 1,
                        column= 0)
